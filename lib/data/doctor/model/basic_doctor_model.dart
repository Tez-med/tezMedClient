...
BasicDoctorModel basicDoctorModelFromJson(String str) => BasicDoctorModel.fromJson(json.decode(str));

String basicDoctorModelToJson(BasicDoctorModel data) => json.encode(data.toJson());
...
class BasicDoctorModel {
    ...
    factory BasicDoctorModel.fromJson(Map<String, dynamic> json) => BasicDoctorModel(
        id: json["id"],
