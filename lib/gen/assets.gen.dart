...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/attached.svg
  SvgGenImage get attached => const SvgGenImage('assets/icons/attached.svg');
  ...
  /// File path: assets/icons/came.svg
  SvgGenImage get came => const SvgGenImage('assets/icons/came.svg');
  ...
  /// File path: assets/icons/history_empty.svg
  SvgGenImage get historyEmpty => const SvgGenImage('assets/icons/history_empty.svg');
  ...
  SvgGenImage get notificationEmpty =>
      const SvgGenImage('assets/icons/notification_empty.svg');

  /// File path: assets/icons/nurse.svg
  SvgGenImage get nurse => const SvgGenImage('assets/icons/nurse.svg');
...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/not_connection.json
  LottieGenImage get notConnection =>
      const LottieGenImage('assets/lottie/not_connection.json');
  ...
  List<LottieGenImage> get values =>
      [loading, network, notConnection, serverError, success];
}

class $AssetsPirvacyPolicyGen {
  const $AssetsPirvacyPolicyGen();

  /// File path: assets/pirvacy_policy/privacy_policy.md
  String get privacyPolicyMd => 'assets/pirvacy_policy/privacy_policy.md';

  /// File path: assets/pirvacy_policy/privacy_policy.txt
  String get privacyPolicyTxt => 'assets/pirvacy_policy/privacy_policy.txt';

  /// List of all assets
  List<String> get values => [privacyPolicyMd, privacyPolicyTxt];
}
...
class Assets {
  ...
  static const $AssetsPirvacyPolicyGen pirvacyPolicy = $AssetsPirvacyPolicyGen();
}
